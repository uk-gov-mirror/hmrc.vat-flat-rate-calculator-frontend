...
class KeystoreConnector @Inject()(appConfig: AppConfig,
                                  vfrSessionCache: VfrSessionCache,
                                  servicesConfig: ServicesConfig,
                                  messages: MessagesApi) extends ServicesConfig {
  lazy val sessionCache: VfrSessionCache = vfrSessionCache
  lazy val http = WSHttp
  lazy val serviceUrl: String = baseUrl(messages("service.base.url"))
